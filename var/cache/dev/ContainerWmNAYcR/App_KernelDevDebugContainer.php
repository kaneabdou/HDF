...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventListener'.\DIRECTORY_SEPARATOR.'MovieSearchSubscriber.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventListener\\MovieSearchSubscriber')] fn () => ($container->privates['App\\EventListener\\MovieSearchSubscriber'] ?? self::getMovieSearchSubscriberService($container)), 'onKernelRequest'], 0);
     ...
     */
    protected static function getKnpPaginatorService($container, $lazyLoad = true)
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxy9cc2a8f', static fn () => \PaginatorProxy9cc2a8f::createLazyProxy(static fn () => self::getKnpPaginatorService($container, false)));
        }
    ...
    /**
     * Gets the private 'App\EventListener\MovieSearchSubscriber' shared autowired service.
     *
     * @return \App\EventListener\MovieSearchSubscriber
     */
    protected static function getMovieSearchSubscriberService($container)
    {
        $a = ($container->services['knp_paginator'] ?? self::getKnpPaginatorService($container));

        if (isset($container->privates['App\\EventListener\\MovieSearchSubscriber'])) {
            return $container->privates['App\\EventListener\\MovieSearchSubscriber'];
        }

        return $container->privates['App\\EventListener\\MovieSearchSubscriber'] = new \App\EventListener\MovieSearchSubscriber($a);
    }
