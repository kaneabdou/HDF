...
class __TwigTemplate_76be8fba6bf7e6c3dbf795c872d38b90 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["actor"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["actor"], "deathYear", [], "any", true, true, false, 23) && $this->extensions['App\Extensions\CustomTwigExtension']->isInteger(twig_get_attribute($this->env, $this->source, $context["actor"], "deathYear", [], "any", false, false, false, 23)))) {
                    // line 24
                    echo "                                        <p class=\"card-subtitle\">Date de décès :";
                ...
                echo "                                    <p class=\"card-subtitle\">Profession(s):</p>
                                    <ul>
                                        ";
                // line 28
                $context["professions"] = twig_split_filter($this->env, (isset($context["professions"]) || array_key_exists("professions", $context) ? $context["professions"] : (function () { throw new RuntimeError('Variable "professions" does not exist.', 28, $this->source); })()), ",");
                // line 29
                echo "                                        ";
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable((isset($context["professions"]) || array_key_exists("professions", $context) ? $context["professions"] : (function () { throw new RuntimeError('Variable "professions" does not exist.', 29, $this->source); })()));
                ...
                echo "                                    </ul>
                                    <a href=\"";
                // line 33
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("actor", ["id" => twig_get_attribute($this->env, $this->source, $context["actor"], "nconst", [], "any", false, false, false, 33)]), "html", null, true);
    ...
    ";
        ...
        ";
        // line 45
        echo $this->env->getRuntime('Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationRuntime')->render($this->env, (isset($context["pagination"]) || array_key_exists("pagination", $context) ? $context["pagination"] : (function () { throw new RuntimeError('Variable "pagination" does not exist.', 45, $this->source); })()));
        echo "
    </div>
";
    ...
    {
        return array (  157 => 45,  154 => 44,  149 => 40,  142 => 38,  131 => 33,  128 => 32,  119 => 30,  114 => 29,  112 => 28,  108 => 26,  102 => 24,  100 => 23,  96 => 22,  91 => 21,  89 => 20,  84 => 17,  80 => 16,  71 => 9,  67 => 8,  59 => 4,  52 => 3,  35 => 1,);
    }
